const data = [
  ...
  {
    id: 5,
    artist: 'Five fingers death punch',
    album: 'Got your six',
    released: 2015,
    label: 'Prospect Park',
    location: 'U.S.',
  ...
  },
  {
    ...
    location: 'U.S.',
    genre: ['pop'],
    cover: 'https://m.media-amazon.com/images/I/81a66iIiZeL._AC_SL1500_.jpg',
  },
  {
    id: 8,
    artist: 'The Hardkiss',
    album: 'Залiзна лiставка',
    released: 2018,
    label: 'Comp Music',
    location: 'Ukraine',
  ...
  },
  {
    ...
    cover: 'https://lastfm.freetls.fastly.net/i/u/ar0/92ca2474012548aec84e5f3db1b7121d.jpg',
  },
  {
    id: 10,
    artist: 'Океан Эльзи',
